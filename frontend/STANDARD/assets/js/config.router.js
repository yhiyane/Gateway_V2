...
function ($stateProvider, $urlRouterProvider, $controllerProvider, $compileProvider, $filterProvider, $provide, $ocLazyLoadProvider, jsRequires) {
    ...
    $stateProvider.state('app', {
        ...
        resolve: loadSequence('modernizr', 'moment', 'angularMoment', 'uiSwitch', 'perfect-scrollbar-plugin', 'toaster', 'ngAside', 'vAccordion', 'sweet-alert', 'chartjs', 'tc.chartjs', 'oitozero.ngSweetAlert', 'chatCtrl', 'truncate', 'htmlToPlaintext', 'angular-notification-icons','SearchClientController'),
        abstract: true
    }).state('app.dashboard', {
        url: "/dashboard",
        ...
        url: '/elements',
        templateUrl: "assets/views/ListUsers.html",
        title: 'Elements',
        icon: 'ti-layout-media-left-alt',
        controller: 'UserController',
        //resolve:'SearchClientController',
        ncyBreadcrumb: {
            label: 'Elements'
        }
